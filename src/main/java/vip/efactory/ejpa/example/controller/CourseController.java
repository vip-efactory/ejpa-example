...
public class CourseController extends BaseController<Course, ICourseService, Long> {
    ...
    public R save(@RequestBody @ApiParam(name = "entity", value = "Json格式", required = true) Course entity) {
    ...
    public R updateById(@RequestBody @ApiParam(name = "entity", value = "Json格式", required = true) Course entity) {
