...
public class TeacherController extends BaseController<Teacher, ITeacherService, Long> {
    ...
    public R save(@RequestBody @ApiParam(name = "entity", value = "Json格式", required = true) Teacher entity) {
    ...
    public R updateById(@RequestBody @ApiParam(name = "entity", value = "Json格式", required = true) Teacher entity) {
