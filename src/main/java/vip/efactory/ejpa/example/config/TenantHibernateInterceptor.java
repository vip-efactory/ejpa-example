...
//        if (entity instanceof TenantBaseEntity) {
//            log.debug("[find-dirty] Updating the entity with tenant information: " + TenantHolder.getTenantId());
//            ((TenantBaseEntity) entity).setTenantId(TenantHolder.getTenantId());
//        }
//        return null;
//    }
...
//            log.debug("[get-EntityName] Updating the entity with tenant information: " + TenantHolder.getTenantId());
//            ((TenantBaseEntity) object).setTenantId(TenantHolder.getTenantId());
//        }
//        return null;
//    }
//
